...
/**
 * @brief Aggregates all systems and provides a unified interface for the game
 * world.
 *
...
public:
   ...
   * This handles anatomy, physiology, etc. in a single pass or coordinated
   * passes.
   */
   ...
   */
  bool inflictWound(Entity *target, const std::string &partName, int damage,
                    int bleedSeverity = 0);
...
private:
  ...
  std::unordered_set<int>
      active_anatomy_entities; // Entities needing updates this turn
};
