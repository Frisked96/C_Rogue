...
namespace BioTags {
    ...
    // -------------------------------------------------------------------------
    constexpr const char* CIRCULATION = "Circulation"; // Required for Oxygen transport
    ...
    constexpr const char* FILTRATION  = "Filtration";  // Removes Toxins/Drug accumulation
    constexpr const char* ENDOCRINE   = "Endocrine";   // Regulates Stress/Adrenaline recovery
    ...
    constexpr const char* THERMAL_GEN  = "ThermalGen";   // Body heat generation (resistance to cold)
